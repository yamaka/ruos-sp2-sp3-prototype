...
$(document).ready(function () {
  ...
  var caRUOSelWithControl = $(".caRUOSel-with-control");
  if (caRUOSelWithControl.length != 0) {
    caRUOSelWithControl.owlCaRUOSel({
      items: 1,
      autoplay: true,
      loop: true,
      dots: false,
  ...
  var caRUOSelWithIndicators = $(".caRUOSel-with-indicators");
  if (caRUOSelWithIndicators.length != 0) {
    caRUOSelWithIndicators.owlCaRUOSel({
      items: 1,
      autoplay: true,
      loop: true,
      nav: true,
  ...
  var caoruselWithCaptions = $(".caRUOSel-with-captions");
  if (caoruselWithCaptions.length != 0) {
    caoruselWithCaptions.owlCaRUOSel({
      items: 1,
      autoplay: true,
      loop: true,
      nav: true,
  ...
  var caRUOSelUser = $(".caRUOSel-user");
  if (caRUOSelUser.length != 0) {
    caRUOSelUser.owlCaRUOSel({
      items: 4,
      margin: 80,
      autoplay: true,
      loop: true,
  ...
  var caRUOSelTestimonial = $(".caRUOSel-testimonial");
  if (caRUOSelTestimonial.length != 0) {
    caRUOSelTestimonial.owlCaRUOSel({
      items: 3,
      margin: 135,
      autoplay: false,
      loop: true,
